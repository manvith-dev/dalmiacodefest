...
async function LeaderBoardTable() {
  ...
  try {
    ...
    round3analysis = await Round3Player.find()
      .populate("teamId")
      .sort({
        score: -1,
        timeTaken: 1,
    ...
    if (!round3analysis || round3analysis.length === 0) {
  ...
  return (
    <section className="w-full px-8 ">
      <Table className="w-full">
        <TableCaption>Round 3 Leaderboard</TableCaption>
        ...
        <TableBody>
          {round3analysis.map((player: any, index: number) => {
