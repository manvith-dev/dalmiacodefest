...
import { END_TIME_KEY, STORAGE_KEY } from "@/features/round2/config/constants";
...
function Round2LoginForm() {
  ...
  async function handleFormSubmit() {
    ...
    try {
      ...
      const res = await fetch("/api/round2/login", {
        method: "POST",
